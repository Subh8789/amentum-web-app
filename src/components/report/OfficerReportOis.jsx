...
const OfficerReportOis = ({ dropoffData = [], loading, error }) => {
    ...
    const handleDownloadReport = async () => {
        ...
        const apiUrl = `https://app.swglobalstaging.com/api/v1/waybill/track/report?type=drop&startDate=${startDate}&endDate=${endDate}&service=ois&user=${selectedUser}`;
...
export default OfficerReportOis;
